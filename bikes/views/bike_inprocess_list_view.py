...
def bike_inprocess_list(request):
    ...
    if request.method == "GET":
        ...
        bikes_in_process = Bike.objects.filter(user_id=current_user.id, status_id=3)
        ...
        context = {"bike_list": bikes_in_process, "all_bike_count": all_bike_count, "sold_bikes": sold_bikes, "listed_bikes": listed_bikes, "in_process_bikes": in_process_bikes}
        return render(request, 'bikes/process_list.html', context)
