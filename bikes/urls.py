...
urlpatterns = [
    ...
    path('mybikes/sold', views.bike_sold_list, name='sold_list'),
    path('mybikes/listed', views.bike_listed_list, name='listed_list'),
    path('mybikes/process', views.bike_inprocess_list, name='process_list'),
